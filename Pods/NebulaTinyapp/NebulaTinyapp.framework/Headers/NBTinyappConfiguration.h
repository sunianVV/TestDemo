...
@property(nonatomic, assign)  BOOL                                          tinyInpageRenderShouldFixTouchEvent;
@property(nonatomic, copy)    NSArray                                       *tinyIPRSkipWKGes;
@property(nonatomic, copy)    NSArray                                       *tinyNewTouchEventWhiteList;
//10.1.68 arraybuffer通道配置
@property (nonatomic, strong) NSDictionary                                  *tinyappArrayBufferChannelConfig;
